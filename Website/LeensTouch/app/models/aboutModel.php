<?php
    ...
    Class aboutModel{
        ...
        public function updateAbout($data){
            $this->db->query("UPDATE about SET first_paragraph=:first_paragraph, second_paragraph=:second_paragraph, third_paragraph=:third_paragraph WHERE aboutID=:about_id");
