...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="/LeensTouch/User/getUsers">Get Users</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/LeensTouch/User/createUser">Create User</a>
</li>
    ...
    <table  class="table table-bordered">
        ...
        <?php
            foreach($data["users"] as $user){
                ...
                echo"<td>
                <a href='/LeensTouch/User/details/$user->ID'> Details</a>
                </td>";
                echo"<td>
                <a href='/LeensTouch/User/update/$user->ID'> Update</a>
                </td>";
                echo"<td>
                <a href='/LeensTouch/User/delete/$user->ID'> Delete</a>
                </td>";
                echo"</tr>";
