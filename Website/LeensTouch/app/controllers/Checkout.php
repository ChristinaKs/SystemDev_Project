<?php
    class Checkout extends Controller{
        ...
        foreach($newarray as $item){
            $isSucc = $this->orderModel->createOrder($_SESSION['user_id'], $item['total_price']);
        }

        foreach($newnewnew as $order){
            $isSucc = $this->orderModel->createOrderDetails($order['order_id']->order_id , $order['upc'], $order['name'], $order['quantity'], $order['total_price'],
